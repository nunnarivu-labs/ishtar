...
**Website:** [**https://ishtar.nunnarivulabs.in**](https://ishtar.nunnarivulabs.in)
...
*   **Secure & Scalable Serverless Backend:**
    ...
    *   **Automated Data Management:**
        *   A scheduled Cloud Function runs daily at 8:30 AM IST to permanently delete conversations marked for deletion.
        *   An event-driven Cloud Function listens for conversation deletions and automatically removes associated attachments from Firebase Storage, ensuring no orphaned files remain.
